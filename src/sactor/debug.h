...
#define SACTOR_DEFINE_COMPONENT_LOG(Component, ObjectName) \
    static const char* SACTOR_COMPONENT_NAME = Component; \
    static const char* SACTOR_COMPONENT_OBJECT_NAME = ObjectName

#define SACTOR_COMPONENT_LOGV(Format, ...) SACTOR_LOGV(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_LOGD(Format, ...) SACTOR_LOGD(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_LOGI(Format, ...) SACTOR_LOGI(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_LOGW(Format, ...) SACTOR_LOGW(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_LOGE(Format, ...) SACTOR_LOGE(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_LOGF(Format, ...) SACTOR_LOGF(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, this, Format, ##__VA_ARGS__)

#define SACTOR_COMPONENT_SLOGV(Format, ...) SACTOR_LOGV(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_SLOGD(Format, ...) SACTOR_LOGD(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_SLOGI(Format, ...) SACTOR_LOGI(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_SLOGW(Format, ...) SACTOR_LOGW(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_SLOGE(Format, ...) SACTOR_LOGE(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
#define SACTOR_COMPONENT_SLOGF(Format, ...) SACTOR_LOGF(SACTOR_COMPONENT_NAME, SACTOR_COMPONENT_OBJECT_NAME, nullptr, Format, ##__VA_ARGS__)
